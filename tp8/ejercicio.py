...
def generar_graficos(df, producto):
    ...
    datos_producto["day"] = 1  # Agregar columna 'day' con valores predeterminados
    ...
    ax.plot(
        ...
        label=f"{producto}",  # Cambiado para mostrar el nombre del producto
        color="blue"
    )
...
def mostrar_datos(df, sucursal):
    ...
    for _, row in resumen.iterrows():
        with st.container():
            ...
            col1, col2 = st.columns([1, 3])  # Dividir en dos columnas
            with col1:
